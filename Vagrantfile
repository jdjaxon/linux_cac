...
Vagrant.configure("2") do |config|
  config.vm.define "ubuntu22" do |cfg|
    ...
    cfg.vm.provision "shell", inline: 'sudo apt upgrade -y'
    ...
    cfg.vm.provision "shell", inline: 'sudo apt install -y google-chrome-stable firefox'
    cfg.vm.provision "shell", inline: 'sudo apt install -f'
    cfg.vm.provision "shell", inline: 'sudo usermod -aG sudo vagrant'
